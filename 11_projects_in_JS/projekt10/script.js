// $ stary sposób nazywania zmiennych globalnych, obecnie do nazywania zmiennych, które się nigdy nie zmienią używamy wielkich liter np. klucz do API (const API_KEY = 'xyz')

let $todoInput; // miejsce, gdzie użytkownik wpisuje treść
let $alertInfo; // info o braku zadań / konieczności dodania tekstu
let $addBtn; // przycisk dodaj - dodaje nowe elementy do listy
let $ulList; // nasza lista zadań, tagi ul
let $newTask; // nowo dodany Li, nowe zadanie
let $allTasks; // lista wszyskich dodanych li
